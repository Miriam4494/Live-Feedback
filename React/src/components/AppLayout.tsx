...
// import { clearUser } from "../redux/UserSlice"; // Import ה-clearUser
...
//                 mb: 1,
//                 borderRadius: 2,
//                 bgcolor: isActive("/fileupload") ? alpha(theme.palette.primary.main, 0.1) : "transparent",
//                 color: isActive("/fileupload") ? theme.palette.primary.main : "inherit",
//                 "&:hover": { bgcolor: alpha(theme.palette.primary.main, 0.05) },
//               }}
//             >
//               <ListItemIcon>
//                 <AddIcon color={isActive("/fileupload") ? "primary" : "inherit"} />
//               </ListItemIcon>
...
//                 mb: 1,
//                 borderRadius: 2,
//                 bgcolor: isActive("/all") ? alpha(theme.palette.primary.main, 0.1) : "transparent",
//                 color: isActive("/all") ? theme.palette.primary.main : "inherit",
//                 "&:hover": { bgcolor: alpha(theme.palette.primary.main, 0.05) },
//               }}
//             >
//               <ListItemIcon>
//                 <ViewListIcon color={isActive("/all") ? "primary" : "inherit"} />
//               </ListItemIcon>
...
//                 mb: 1,
//                 borderRadius: 2,
//                 bgcolor: isActive("/myface") ? alpha(theme.palette.primary.main, 0.1) : "transparent",
//                 color: isActive("/myface") ? theme.palette.primary.main : "inherit",
//                 "&:hover": { bgcolor: alpha(theme.palette.primary.main, 0.05) },
//               }}
//             >
//               <ListItemIcon>
//                 <PersonIcon color={isActive("/myface") ? "primary" : "inherit"} />
//               </ListItemIcon>
...
//                         sx={{
//                           ...navButtonStyle,
//                           color: isActive("/fileupload") ? theme.palette.primary.main : "text.primary",
//                           fontWeight: isActive("/fileupload") ? 700 : 500,
//                           "&::after": {
//                             content: '""',
//                             position: "absolute",
//                             bottom: 0,
//                             left: "50%",
//                             width: isActive("/fileupload") ? "80%" : "0%",
//                             height: "3px",
//                             bgcolor: "primary.main",
//                             transform: "translateX(-50%)",
//                             transition: "width 0.3s ease",
...
//                         sx={{
//                           ...navButtonStyle,
//                           color: isActive("/all") ? theme.palette.primary.main : "text.primary",
...
//                         sx={{
//                           ...navButtonStyle,
//                           color: isActive("/myface") ? theme.palette.primary.main : "text.primary",
//                           fontWeight: isActive("/myface") ? 700 : 500,
//                           "&::after": {
//                             content: '""',
//                             position: "absolute",
//                             bottom: 0,
//                             left: "50%",
//                             width: isActive("/myface") ? "80%" : "0%",
//                             height: "3px",
//                             bgcolor: "primary.main",
//                             transform: "translateX(-50%)",
//                             transition: "width 0.3s ease",
...
//       {isAuthenticated && user?.points !== undefined && (
//         <Box
//           sx={{
//             display: "flex",
//             alignItems: "center",
...
//               thickness={6}
//               sx={{
//                 color: user.points >= 50 ? "success.main" : "warning.main",
